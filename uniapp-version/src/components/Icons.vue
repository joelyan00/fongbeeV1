...
const ICONS: Record<string, string> = {
  ...
  'wechat': '<path fill="#09BB07" d="M11.66 1.63c-3.79 0-6.86 2.87-6.86 6.42 0 1.99.98 3.79 2.52 4.96-.34 1.12-1.25 2.1-1.39 2.22-.16.13.06.36.26.24 1.34-.84 2.84-1.34 3.39-1.46.65.18 1.35.28 2.08.28.32 0 .63-.02.94-.05-.41-.83-.63-1.77-.63-2.75 0-3.69 3.01-6.69 6.72-6.69.41 0 .82.04 1.21.1-1.42-1.92-4.14-3.27-7.24-3.27z"/><path fill="#fff" d="M20.25 8.95c-3.14 0-5.69 2.41-5.69 5.39 0 1.68.74 3.16 1.94 4.14-.19.68-1.07 1.83-1.21 2.02-.15.19.1.51.35.35 1.48-.96 2.76-1.57 3.33-1.74.45.1.91.17 1.38.17 3.14 0 5.69-2.41 5.69-5.39s-2.55-5.39-5.69-5.39z"/><circle fill="#000" fill-opacity="0.3" cx="8.58" cy="6.28" r=".63"/><circle fill="#000" fill-opacity="0.3" cx="14.74" cy="6.28" r=".63"/><circle fill="#09BB07" cx="17.17" cy="12.28" r=".53"/><circle fill="#09BB07" cx="23.33" cy="12.28" r=".53"/>',
