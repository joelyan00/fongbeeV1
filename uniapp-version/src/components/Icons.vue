...
const ICONS: Record<string, string> = {
  ...
  'google': '<path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 14.93c-2.48 0-4.5-2.02-4.5-4.5 0-2.48 2.02-4.5 4.5-4.5 1.08 0 2.1.39 2.91 1.05l-1.07 1.07c-.42-.36-1.01-.62-1.84-.62-1.66 0-3 1.34-3 3s1.34 3 3 3c1.71 0 2.65-1.14 2.78-2.6H13v-1.6h5.45c.06.28.1.58.1.9 0 2.97-2.06 5.3-5.55 5.3z"></path>',
  'wechat': '<path d="M8 12c-3.31 0-6-2.24-6-5s2.69-5 6-5 6 2.24 6 5-2.69 5-6 5zm0-8c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zm11 7c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zm0-6c-3.31 0-6 2.24-6 5s2.69 5 6 5 6-2.24 6-5-2.69-5-6-5z"></path>',
  ...
  'apple': '<path d="M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"></path>',
