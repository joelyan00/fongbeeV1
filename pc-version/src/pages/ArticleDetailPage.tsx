...
import { cmsApi, type Article } from '../services/api';
import { Calendar, Eye, ArrowLeft, User, Folder } from 'lucide-react';
...
const ArticleDetailPage: React.FC = () => {
    ...
    useEffect(() => {
        const fetchArticle = async () => {
            ...
            try {
                setIsLoading(true);
                const res = await cmsApi.getById(id);
                if (res.article) {
            ...
            <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pt-28">
                ...
                <div className="mb-8">
                    ...
                    >
                        ...
                        <span className="font-bold text-sm">返回列表</span>
                    </button>
                </div>
